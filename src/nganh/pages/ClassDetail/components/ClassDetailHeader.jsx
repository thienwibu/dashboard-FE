...
import { Users, Clock, MapPin, Calendar, TrendingUp, Award, AlertTriangle } from 'lucide-react';
      ...
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between space-y-4 lg:space-y-0">
        ...
        <div className="grid grid-cols-3 gap-4 lg:w-80">
          <div className="text-center p-4 bg-primary-50 rounded-lg">
            ...
            <p className="text-2xl font-bold text-primary-600">{(classData.averageScore || 0).toFixed(1)}</p>
